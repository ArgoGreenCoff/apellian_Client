...
<div id="wrap">
	...
	<nav id="gnb">
		<ul class="gnb">
			...
			<li class="active"><a class="mn05" href="">더보기</a></li>
		</ul>
	</nav>
...
<div class="container-pn">
	<h1 class="display-2 bd-tit">자주하는 질문</h1>   
    <ul class="list-basic">
       	
       	<c:forEach var="item" items="${faqList}" varStatus="status">
        	<li><a href="/board/noticeDetail?idBoard=${item.idBoard }">${item.nmBoard } <span><fmt:formatDate value="${item.dtReg}" pattern="YYYY.MM.dd" /></span></a></li>
        </c:forEach>
    </ul>
</div>
<!--// 페이지 끝 -->
