...
<!--  <script src="../../static/js/member/agreement03.js" type="text/javascript"></script> -->

<spring:url var="authUrl" value="/member/agreement03" />
</head>
<body>
	<div id="wrap">
	...
	<header id="hd">
		...
		<!-- container -->
			...
			<!-- 페이지 시작 -->
			<div class="container">
				<h1 class="display-2 mt-3">제3자정보제공</h1>
				
				<form class="agreement03-form" id="agreement03Form" name="agreement03Form" method="post" action="${authUrl}">
