...
<spring:url var="authUrl" value="/member/agreement01" />
</head>
<body>
	<div id="wrap">
	...
	<header id="hd">
		...
		<!-- container -->
			...
			<!-- 페이지 시작 -->
			<div class="container">
				<h1 class="display-2 mt-3">이용약관</h1>   
				
				<form class="agreement01-form" id="agreement01Form" name="agreement01Form" method="post" action="${authUrl}">
