...
<!--  <script src="../../static/js/member/agreement01.js" type="text/javascript"></script> -->

<spring:url var="authUrl" value="/member/agreement02" />
</head>
<body>
	<div id="wrap">
	...
	<header id="hd">
		...
		<!-- container -->
			...
			<!-- 페이지 시작 -->
			<div class="container">
				<h1 class="display-2 mt-3">개인정보수집</h1>
				
				<form class="agreement02-form" id="agreement02Form" name="agreement02Form" method="post" action="${authUrl}">
