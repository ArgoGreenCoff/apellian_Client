	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">상담 신청이<br>완료되었습니다.</h5>
			</div>
			<div class="modal-body">
				<p>업체가 연락드릴 예정입니다.<br>문의: <a href="tel:02-548-1508" class="text-primary font-num">02-548-1508</a> (세인트플래닝)</p>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-dark" data-dismiss="modal" onclick="location.href='/package/packageList?email=${email}'">확인</button>
			</div>
		</div>
	</div>
</div>
